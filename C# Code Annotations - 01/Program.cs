...
and useful functions (Without it we'd have to type System.Console.WriteLine)
*/
using System;
...
namespace HelloWorld
{
    ...
    public class Program
    {
        ...
        private static void SayHello()
        {
            ...
            // Defines a variable that will store a string of characters
            // Save the input the user provides
            string name = Console.ReadLine();
            Console.WriteLine($"Hello {name}");
        }

        // If you assign a value then it is optional to pass
        ...
        {
            Console.WriteLine($"{name} lives in a city that the zip code is {zipCode}");
        }

        // ----- METHOD OVERLOADING -----
        // You can pass different type of data to the same function
        ...
        enum CarColor : byte
        {
            Orange = 1, // the value will increment
            Blue, // this will be 2
            Green, // 3 and etc
            Red,
            Yellow
        ...
        // static means this function can run without creating an object
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Biggest Float : {float.MaxValue.ToString("#")}");
            ...
            // Cast double into integer (Explicit Conversion), may cause lost data
            // Put the data type to convert into between ()
            double dblNum = 12.345;
            Console.WriteLine($"Integer : {(int)dblNum}");

            // Cast integer into long (Implicit Conversion), does not lost data
            ...
            Console.WriteLine($"Currency : {23.455:c}");

            // Pad with zeros
            Console.WriteLine($"Pad with 0s : {23:d4}");

            // Define decimals
            Console.WriteLine($"3 Decimals : {23.4555:f3}");

            // Add commas and decimals
            Console.WriteLine($"Commas : {2300:n4}");
            ...
            // Add padding right
            Console.WriteLine($"Pad Right : {randString.PadRight(20, '.')} Stuff");

            // Trim whitespace
            Console.WriteLine($"Trim : {randString.Trim()}");

            // Make uppercase
            Console.WriteLine($"Uppercase : {randString.ToUpper()}");

            // Make lowercase
            Console.WriteLine($"Lowercase : {randString.ToLower()}");
            ...
            // Add a value to the array on the first index(0)
            favNums[0] = 23;
            ...
            Console.WriteLine($"randomArray 0 : {randomArray[0].GetType()}");

            // Get number of items in array
            Console.WriteLine($"Array Size : {randomArray.Length}");

            // Use for loop to cycle through the array
            for (int j = 0; j < randomArray.Length; j++)
            {
                Console.WriteLine($"Array {j} : Value : {randomArray[j]}");
            }
            ...
            Console.WriteLine($"MD Value : {custNames.GetValue(1, 1)}"); // get the value on the second row and second line
            ...
            // Ternary Operator Assigns the 1st value if true and otherwise the 2nd
        ...
        OtherSchool:
            ...
            string name2 = "Marllon";
            string name3 = "Marllon";
            ...
            do
            {
                ...
                Console.WriteLine(numberGuessed.GetType());

                if (numberGuessed <= 0 || numberGuessed >= 11)
                {
                    Console.WriteLine("Insert a valid number!");
                }
                else if (numberGuessed > secretNumber)
                {
                    Console.WriteLine("The number you guessed is higher than the answer!");
                }
                else if (numberGuessed < secretNumber)
                {
                    Console.WriteLine("The number you guessed is lower than the answer!");
                }
            ...
            Console.WriteLine($"Insert : {sb2.ToString()}");

            // Remove number of characters starting at index
            sb2.Remove(11, 7);

            Console.WriteLine($"Remove : {sb2.ToString()}");
            ...
            PrintInfo(zipCode: 435453, name: "Marllon");
